...
def train(args, lfd_params, model):
    ...
    elif args.suffix in ['linear', 'linear_iad']:
...
def parse_exec_args():
    ...
    parser.add_argument('--frames', help='number of frames to be sampled form training video', default=64, type=int)
    parser.add_argument('--repeat', help='number of times to re-run the code', default=1, type=int)
